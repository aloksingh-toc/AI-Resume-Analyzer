...
const styles = {
  wrap:    { background: '#f8faff', border: `1px solid ${C.border}`, borderRadius: '12px', padding: '14px 16px', marginBottom: '12px', display: 'flex', flexDirection: 'column', gap: '12px', overflow: 'hidden' },
  group:   { minWidth: 0 },
  label:   { display: 'block', fontSize: '11px', fontWeight: '700', color: C.muted, textTransform: 'uppercase', letterSpacing: tracking.tight, marginBottom: '8px' },
