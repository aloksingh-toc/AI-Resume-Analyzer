import { darkTokens as D, tracking } from '../theme'
...
const styles = {
  ...
  label:     { fontSize: '11px', fontWeight: '700', letterSpacing: tracking.wide, color: D.textMuted, marginBottom: '20px' },
  ...
  connector: { position: 'absolute', top: '38px', right: 'calc(var(--hiw-gap, 16px) * -0.5)', width: 'calc(var(--hiw-gap, 16px) * 1)', height: '2px', background: `linear-gradient(90deg, ${D.border}, transparent)`, zIndex: 1 },
